...
@Generated
public fun Construct.cfnFirewallRuleGroup(id: String, initializer: @AwsCdkDsl CfnFirewallRuleGroup.() -> Unit = {}): CfnFirewallRuleGroup = CfnFirewallRuleGroup(this, id).apply(initializer)
...
@Generated
public fun Construct.buildCfnFirewallRuleGroup(id: String, initializer: @AwsCdkDsl CfnFirewallRuleGroup.Builder.() -> Unit = {}): CfnFirewallRuleGroup = CfnFirewallRuleGroup.Builder.create(this, id).apply(initializer).build()
