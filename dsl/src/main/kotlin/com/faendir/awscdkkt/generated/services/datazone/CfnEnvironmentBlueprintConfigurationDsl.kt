...
): CfnEnvironmentBlueprintConfiguration = CfnEnvironmentBlueprintConfiguration(this, id, props).apply(initializer)

@Generated
public fun Construct.buildCfnEnvironmentBlueprintConfiguration(id: String, initializer: @AwsCdkDsl CfnEnvironmentBlueprintConfiguration.Builder.() -> Unit = {}): CfnEnvironmentBlueprintConfiguration = CfnEnvironmentBlueprintConfiguration.Builder.create(this, id).apply(initializer).build()
