...
@Generated
public fun Construct.buildPublicDnsNamespace(id: String, initializer: @AwsCdkDsl PublicDnsNamespace.Builder.() -> Unit = {}): PublicDnsNamespace = PublicDnsNamespace.Builder.create(this, id).apply(initializer).build()
