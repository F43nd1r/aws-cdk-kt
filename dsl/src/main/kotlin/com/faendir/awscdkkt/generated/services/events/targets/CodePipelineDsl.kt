...
@Generated
public fun buildCodePipeline(pipeline: IPipelineRef, initializer: @AwsCdkDsl CodePipeline.Builder.() -> Unit = {}): CodePipeline = CodePipeline.Builder.create(pipeline).apply(initializer).build()
