...
@Generated
public fun Construct.buildWebSocketRoute(id: String, initializer: @AwsCdkDsl WebSocketRoute.Builder.() -> Unit = {}): WebSocketRoute = WebSocketRoute.Builder.create(this, id).apply(initializer).build()
