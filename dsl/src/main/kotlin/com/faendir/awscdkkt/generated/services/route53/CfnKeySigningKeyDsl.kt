...
@Generated
public fun Construct.cfnKeySigningKey(id: String, props: CfnKeySigningKeyProps): CfnKeySigningKey =
    CfnKeySigningKey(this, id, props)
...
public fun Construct.buildCfnKeySigningKey(id: String, initializer: @AwsCdkDsl
    CfnKeySigningKey.Builder.() -> Unit): CfnKeySigningKey = CfnKeySigningKey.Builder.create(this,
