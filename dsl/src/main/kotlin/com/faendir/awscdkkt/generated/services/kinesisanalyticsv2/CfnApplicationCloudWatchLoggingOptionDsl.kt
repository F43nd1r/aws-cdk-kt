...
@Generated
public fun Construct.cfnApplicationCloudWatchLoggingOption(id: String,
    props: CfnApplicationCloudWatchLoggingOptionProps): CfnApplicationCloudWatchLoggingOption =
    CfnApplicationCloudWatchLoggingOption(this, id, props)
...
public fun Construct.buildCfnApplicationCloudWatchLoggingOption(id: String, initializer: @AwsCdkDsl
    CfnApplicationCloudWatchLoggingOption.Builder.() -> Unit): CfnApplicationCloudWatchLoggingOption
