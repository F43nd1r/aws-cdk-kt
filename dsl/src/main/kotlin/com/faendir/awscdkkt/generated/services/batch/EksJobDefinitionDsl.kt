...
@Generated
public fun Construct.buildEksJobDefinition(id: String, initializer: @AwsCdkDsl
    EksJobDefinition.Builder.() -> Unit = {}): EksJobDefinition =
    EksJobDefinition.Builder.create(this, id).apply(initializer).build()
