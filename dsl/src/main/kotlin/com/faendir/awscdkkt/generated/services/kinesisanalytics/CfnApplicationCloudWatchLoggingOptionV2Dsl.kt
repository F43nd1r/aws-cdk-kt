...
@Generated
public fun Construct.cfnApplicationCloudWatchLoggingOptionV2(id: String,
    props: CfnApplicationCloudWatchLoggingOptionV2Props): CfnApplicationCloudWatchLoggingOptionV2 =
    CfnApplicationCloudWatchLoggingOptionV2(this, id, props)
...
@Generated
public fun Construct.buildCfnApplicationCloudWatchLoggingOptionV2(id: String,
    initializer: @AwsCdkDsl CfnApplicationCloudWatchLoggingOptionV2.Builder.() -> Unit):
    CfnApplicationCloudWatchLoggingOptionV2 =
    CfnApplicationCloudWatchLoggingOptionV2.Builder.create(this, id).apply(initializer).build()
