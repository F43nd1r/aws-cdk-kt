...
@Generated
public fun Construct.cfnSAMLProvider(id: String, initializer: @AwsCdkDsl CfnSAMLProvider.() -> Unit = {}): CfnSAMLProvider = CfnSAMLProvider(this, id).apply(initializer)
...
@Generated
public fun Construct.buildCfnSAMLProvider(id: String, initializer: @AwsCdkDsl CfnSAMLProvider.Builder.() -> Unit = {}): CfnSAMLProvider = CfnSAMLProvider.Builder.create(this, id).apply(initializer).build()
