...
@Generated
public fun Construct.buildCfnMember(id: String, initializer: @AwsCdkDsl CfnMember.Builder.() -> Unit = {}): CfnMember = CfnMember.Builder.create(this, id).apply(initializer).build()
