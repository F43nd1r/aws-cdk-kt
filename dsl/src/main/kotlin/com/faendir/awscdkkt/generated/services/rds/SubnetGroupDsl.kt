...
@Generated
public fun Construct.buildSubnetGroup(id: String, initializer: @AwsCdkDsl SubnetGroup.Builder.() -> Unit = {}): SubnetGroup = SubnetGroup.Builder.create(this, id).apply(initializer).build()
