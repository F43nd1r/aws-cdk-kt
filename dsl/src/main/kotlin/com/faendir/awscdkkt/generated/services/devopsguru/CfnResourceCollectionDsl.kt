...
@Generated
public fun Construct.buildCfnResourceCollection(id: String, initializer: @AwsCdkDsl CfnResourceCollection.Builder.() -> Unit = {}): CfnResourceCollection = CfnResourceCollection.Builder.create(this, id).apply(initializer).build()
