...
@Generated
public fun Construct.cfnClassifier(id: String, initializer: @AwsCdkDsl CfnClassifier.() -> Unit = {}): CfnClassifier = CfnClassifier(this, id).apply(initializer)
...
@Generated
public fun Construct.buildCfnClassifier(id: String, initializer: @AwsCdkDsl CfnClassifier.Builder.() -> Unit = {}): CfnClassifier = CfnClassifier.Builder.create(this, id).apply(initializer).build()
