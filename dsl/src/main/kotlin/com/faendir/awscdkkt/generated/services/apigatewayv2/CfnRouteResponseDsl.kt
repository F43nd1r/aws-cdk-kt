...
@Generated
public fun Construct.cfnRouteResponse(id: String, props: CfnRouteResponseProps): CfnRouteResponse =
    CfnRouteResponse(this, id, props)
...
public fun Construct.buildCfnRouteResponse(id: String, initializer: @AwsCdkDsl
    CfnRouteResponse.Builder.() -> Unit): CfnRouteResponse = CfnRouteResponse.Builder.create(this,
