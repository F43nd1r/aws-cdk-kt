...
@Generated
public fun Construct.buildCfnResolverRule(id: String, initializer: @AwsCdkDsl CfnResolverRule.Builder.() -> Unit = {}): CfnResolverRule = CfnResolverRule.Builder.create(this, id).apply(initializer).build()
