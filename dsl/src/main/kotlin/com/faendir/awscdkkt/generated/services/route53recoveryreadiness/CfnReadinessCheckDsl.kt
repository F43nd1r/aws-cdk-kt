...
@Generated
public fun Construct.cfnReadinessCheck(id: String, initializer: @AwsCdkDsl CfnReadinessCheck.() -> Unit = {}): CfnReadinessCheck = CfnReadinessCheck(this, id).apply(initializer)
...
@Generated
public fun Construct.buildCfnReadinessCheck(id: String, initializer: @AwsCdkDsl CfnReadinessCheck.Builder.() -> Unit = {}): CfnReadinessCheck = CfnReadinessCheck.Builder.create(this, id).apply(initializer).build()
