...
@Generated
public fun Construct.buildCfnProjectProfile(id: String, initializer: @AwsCdkDsl CfnProjectProfile.Builder.() -> Unit = {}): CfnProjectProfile = CfnProjectProfile.Builder.create(this, id).apply(initializer).build()
