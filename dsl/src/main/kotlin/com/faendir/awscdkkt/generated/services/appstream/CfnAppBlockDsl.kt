...
@Generated
public fun Construct.buildCfnAppBlock(id: String, initializer: @AwsCdkDsl CfnAppBlock.Builder.() -> Unit = {}): CfnAppBlock = CfnAppBlock.Builder.create(this, id).apply(initializer).build()
