...
@Generated
public fun Construct.buildCfnReplicationSet(id: String, initializer: @AwsCdkDsl CfnReplicationSet.Builder.() -> Unit = {}): CfnReplicationSet = CfnReplicationSet.Builder.create(this, id).apply(initializer).build()
