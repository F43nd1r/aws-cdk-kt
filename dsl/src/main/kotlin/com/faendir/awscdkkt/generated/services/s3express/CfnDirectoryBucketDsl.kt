...
@Generated
public fun Construct.buildCfnDirectoryBucket(id: String, initializer: @AwsCdkDsl
    CfnDirectoryBucket.Builder.() -> Unit = {}): CfnDirectoryBucket =
    CfnDirectoryBucket.Builder.create(this, id).apply(initializer).build()
