...
@Generated
public fun Construct.buildCfnContactChannel(id: String, initializer: @AwsCdkDsl CfnContactChannel.Builder.() -> Unit = {}): CfnContactChannel = CfnContactChannel.Builder.create(this, id).apply(initializer).build()
