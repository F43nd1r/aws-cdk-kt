...
@Generated
public fun Construct.buildCfnAccessor(id: String, initializer: @AwsCdkDsl CfnAccessor.Builder.() -> Unit = {}): CfnAccessor = CfnAccessor.Builder.create(this, id).apply(initializer).build()
