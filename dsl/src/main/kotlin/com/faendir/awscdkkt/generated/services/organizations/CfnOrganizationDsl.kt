...
@Generated
public fun Construct.cfnOrganization(id: String): CfnOrganization = CfnOrganization(this, id)

@Generated
public fun Construct.cfnOrganization(id: String, initializer: @AwsCdkDsl
    CfnOrganization.() -> Unit): CfnOrganization = CfnOrganization(this, id).apply(initializer)

@Generated
public fun Construct.cfnOrganization(id: String, props: CfnOrganizationProps): CfnOrganization =
    CfnOrganization(this, id, props)
