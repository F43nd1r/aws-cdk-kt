...
@Generated
public fun Construct.bastionHostLinux(id: String, props: BastionHostLinuxProps): BastionHostLinux =
    BastionHostLinux(this, id, props)
...
public fun Construct.buildBastionHostLinux(id: String, initializer: @AwsCdkDsl
    BastionHostLinux.Builder.() -> Unit): BastionHostLinux = BastionHostLinux.Builder.create(this,
