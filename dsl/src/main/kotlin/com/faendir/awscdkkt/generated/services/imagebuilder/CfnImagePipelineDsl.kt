...
@Generated
public fun Construct.buildCfnImagePipeline(id: String, initializer: @AwsCdkDsl CfnImagePipeline.Builder.() -> Unit = {}): CfnImagePipeline = CfnImagePipeline.Builder.create(this, id).apply(initializer).build()
