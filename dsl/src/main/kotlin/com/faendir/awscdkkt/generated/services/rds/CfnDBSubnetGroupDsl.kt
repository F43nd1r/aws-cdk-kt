...
@Generated
public fun Construct.cfnDBSubnetGroup(id: String, props: CfnDBSubnetGroupProps): CfnDBSubnetGroup =
    CfnDBSubnetGroup(this, id, props)
...
public fun Construct.buildCfnDBSubnetGroup(id: String, initializer: @AwsCdkDsl
    CfnDBSubnetGroup.Builder.() -> Unit): CfnDBSubnetGroup = CfnDBSubnetGroup.Builder.create(this,
