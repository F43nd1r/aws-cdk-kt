...
@Generated
public fun Construct.buildNetworkAclEntry(id: String, initializer: @AwsCdkDsl NetworkAclEntry.Builder.() -> Unit = {}): NetworkAclEntry = NetworkAclEntry.Builder.create(this, id).apply(initializer).build()
