...
@Generated
public fun Construct.backupVault(id: String, initializer: @AwsCdkDsl BackupVault.() -> Unit = {}): BackupVault = BackupVault(this, id).apply(initializer)
...
@Generated
public fun Construct.buildBackupVault(id: String, initializer: @AwsCdkDsl BackupVault.Builder.() -> Unit = {}): BackupVault = BackupVault.Builder.create(this, id).apply(initializer).build()
