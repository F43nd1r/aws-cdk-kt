...
@Generated
public fun Construct.cfnEndpointGroup(id: String, props: CfnEndpointGroupProps): CfnEndpointGroup =
    CfnEndpointGroup(this, id, props)
...
public fun Construct.buildCfnEndpointGroup(id: String, initializer: @AwsCdkDsl
    CfnEndpointGroup.Builder.() -> Unit): CfnEndpointGroup = CfnEndpointGroup.Builder.create(this,
