...
@Generated
public fun Construct.cfnSoftwarePackage(id: String, initializer: @AwsCdkDsl
    CfnSoftwarePackage.() -> Unit = {}): CfnSoftwarePackage = CfnSoftwarePackage(this,
...
@Generated
public fun Construct.buildCfnSoftwarePackage(id: String, initializer: @AwsCdkDsl
    CfnSoftwarePackage.Builder.() -> Unit = {}): CfnSoftwarePackage =
    CfnSoftwarePackage.Builder.create(this, id).apply(initializer).build()
