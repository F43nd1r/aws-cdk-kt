...
@Generated
public fun Construct.jobQueue(id: String, initializer: @AwsCdkDsl JobQueue.() -> Unit = {}):
    JobQueue = JobQueue(this, id).apply(initializer)
...
@Generated
public fun Construct.buildJobQueue(id: String, initializer: @AwsCdkDsl JobQueue.Builder.() -> Unit =
    {}): JobQueue = JobQueue.Builder.create(this, id).apply(initializer).build()
