...
public fun buildHierarchicalChunkingConfigurationProperty(initializer: @AwsCdkDsl
    CfnDataSource.HierarchicalChunkingConfigurationProperty.Builder.() -> Unit = {}):
    CfnDataSource.HierarchicalChunkingConfigurationProperty =
    CfnDataSource.HierarchicalChunkingConfigurationProperty.Builder().apply(initializer).build()
