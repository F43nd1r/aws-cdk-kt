...
@Generated
public fun Construct.buildCfnPackageVersion(id: String, initializer: @AwsCdkDsl CfnPackageVersion.Builder.() -> Unit = {}): CfnPackageVersion = CfnPackageVersion.Builder.create(this, id).apply(initializer).build()
