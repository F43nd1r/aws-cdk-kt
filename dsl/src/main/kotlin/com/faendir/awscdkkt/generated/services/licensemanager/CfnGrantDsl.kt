...
@Generated
public fun Construct.cfnGrant(id: String, initializer: @AwsCdkDsl CfnGrant.() -> Unit = {}): CfnGrant = CfnGrant(this, id).apply(initializer)
...
@Generated
public fun Construct.buildCfnGrant(id: String, initializer: @AwsCdkDsl CfnGrant.Builder.() -> Unit = {}): CfnGrant = CfnGrant.Builder.create(this, id).apply(initializer).build()
