...
@Generated
public fun Construct.buildCfnTopicPolicy(id: String, initializer: @AwsCdkDsl CfnTopicPolicy.Builder.() -> Unit = {}): CfnTopicPolicy = CfnTopicPolicy.Builder.create(this, id).apply(initializer).build()
