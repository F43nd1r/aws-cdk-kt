...
@Generated
public fun Construct.cfnLifecycleHook(id: String, props: CfnLifecycleHookProps): CfnLifecycleHook =
    CfnLifecycleHook(this, id, props)
...
public fun Construct.buildCfnLifecycleHook(id: String, initializer: @AwsCdkDsl
    CfnLifecycleHook.Builder.() -> Unit): CfnLifecycleHook = CfnLifecycleHook.Builder.create(this,
