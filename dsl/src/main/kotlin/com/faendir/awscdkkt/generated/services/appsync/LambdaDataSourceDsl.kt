...
@Generated
public fun Construct.lambdaDataSource(id: String, props: LambdaDataSourceProps): LambdaDataSource =
    LambdaDataSource(this, id, props)
...
public fun Construct.buildLambdaDataSource(id: String, initializer: @AwsCdkDsl
    LambdaDataSource.Builder.() -> Unit): LambdaDataSource = LambdaDataSource.Builder.create(this,
