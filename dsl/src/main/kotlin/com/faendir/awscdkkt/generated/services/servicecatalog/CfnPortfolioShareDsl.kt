...
@Generated
public fun Construct.buildCfnPortfolioShare(id: String, initializer: @AwsCdkDsl CfnPortfolioShare.Builder.() -> Unit = {}): CfnPortfolioShare = CfnPortfolioShare.Builder.create(this, id).apply(initializer).build()
