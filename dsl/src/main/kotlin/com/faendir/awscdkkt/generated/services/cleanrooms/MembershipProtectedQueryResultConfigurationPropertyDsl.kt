...
@Generated
public fun buildMembershipProtectedQueryResultConfigurationProperty(initializer: @AwsCdkDsl CfnMembership.MembershipProtectedQueryResultConfigurationProperty.Builder.() -> Unit = {}): CfnMembership.MembershipProtectedQueryResultConfigurationProperty = CfnMembership.MembershipProtectedQueryResultConfigurationProperty.Builder().apply(initializer).build()
