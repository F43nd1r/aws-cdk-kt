...
public fun buildServerSideEncryptionConfigurationProperty(initializer: @AwsCdkDsl
    CfnDataSource.ServerSideEncryptionConfigurationProperty.Builder.() -> Unit = {}):
    CfnDataSource.ServerSideEncryptionConfigurationProperty =
    CfnDataSource.ServerSideEncryptionConfigurationProperty.Builder().apply(initializer).build()
