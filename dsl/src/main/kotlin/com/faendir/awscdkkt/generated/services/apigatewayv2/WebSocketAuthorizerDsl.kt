...
@Generated
public fun Construct.buildWebSocketAuthorizer(id: String, initializer: @AwsCdkDsl WebSocketAuthorizer.Builder.() -> Unit = {}): WebSocketAuthorizer = WebSocketAuthorizer.Builder.create(this, id).apply(initializer).build()
