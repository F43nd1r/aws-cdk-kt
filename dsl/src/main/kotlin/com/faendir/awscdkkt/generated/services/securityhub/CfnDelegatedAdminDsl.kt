...
@Generated
public fun Construct.buildCfnDelegatedAdmin(id: String, initializer: @AwsCdkDsl CfnDelegatedAdmin.Builder.() -> Unit = {}): CfnDelegatedAdmin = CfnDelegatedAdmin.Builder.create(this, id).apply(initializer).build()
