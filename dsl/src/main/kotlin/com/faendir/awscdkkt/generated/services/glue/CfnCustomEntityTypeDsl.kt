...
@Generated
public fun Construct.cfnCustomEntityType(id: String, initializer: @AwsCdkDsl CfnCustomEntityType.() -> Unit = {}): CfnCustomEntityType = CfnCustomEntityType(this, id).apply(initializer)
...
@Generated
public fun Construct.buildCfnCustomEntityType(id: String, initializer: @AwsCdkDsl CfnCustomEntityType.Builder.() -> Unit = {}): CfnCustomEntityType = CfnCustomEntityType.Builder.create(this, id).apply(initializer).build()
