...
@Generated
public fun Construct.buildCfnSubscription(id: String, initializer: @AwsCdkDsl CfnSubscription.Builder.() -> Unit = {}): CfnSubscription = CfnSubscription.Builder.create(this, id).apply(initializer).build()
