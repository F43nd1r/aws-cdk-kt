...
@Generated
public fun Construct.buildCfnADMChannel(id: String, initializer: @AwsCdkDsl CfnADMChannel.Builder.() -> Unit = {}): CfnADMChannel = CfnADMChannel.Builder.create(this, id).apply(initializer).build()
