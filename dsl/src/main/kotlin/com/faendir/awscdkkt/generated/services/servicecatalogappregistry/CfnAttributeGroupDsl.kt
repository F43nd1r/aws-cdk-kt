...
@Generated
public fun Construct.buildCfnAttributeGroup(id: String, initializer: @AwsCdkDsl CfnAttributeGroup.Builder.() -> Unit = {}): CfnAttributeGroup = CfnAttributeGroup.Builder.create(this, id).apply(initializer).build()
