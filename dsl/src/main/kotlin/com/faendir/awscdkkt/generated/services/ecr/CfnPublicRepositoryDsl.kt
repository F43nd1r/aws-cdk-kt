...
@Generated
public fun Construct.cfnPublicRepository(id: String, initializer: @AwsCdkDsl CfnPublicRepository.() -> Unit = {}): CfnPublicRepository = CfnPublicRepository(this, id).apply(initializer)
...
@Generated
public fun Construct.buildCfnPublicRepository(id: String, initializer: @AwsCdkDsl CfnPublicRepository.Builder.() -> Unit = {}): CfnPublicRepository = CfnPublicRepository.Builder.create(this, id).apply(initializer).build()
