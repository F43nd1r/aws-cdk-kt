...
@Generated
public fun Construct.buildCfnPolicyTemplate(id: String, initializer: @AwsCdkDsl
    CfnPolicyTemplate.Builder.() -> Unit = {}): CfnPolicyTemplate =
    CfnPolicyTemplate.Builder.create(this, id).apply(initializer).build()
