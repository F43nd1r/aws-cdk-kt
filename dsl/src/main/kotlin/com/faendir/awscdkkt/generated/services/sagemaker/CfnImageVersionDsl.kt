...
@Generated
public fun Construct.buildCfnImageVersion(id: String, initializer: @AwsCdkDsl CfnImageVersion.Builder.() -> Unit = {}): CfnImageVersion = CfnImageVersion.Builder.create(this, id).apply(initializer).build()
