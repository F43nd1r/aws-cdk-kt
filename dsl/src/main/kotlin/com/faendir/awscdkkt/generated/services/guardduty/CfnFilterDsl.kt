...
@Generated
public fun Construct.buildCfnFilter(id: String, initializer: @AwsCdkDsl CfnFilter.Builder.() -> Unit
    = {}): CfnFilter = CfnFilter.Builder.create(this, id).apply(initializer).build()
