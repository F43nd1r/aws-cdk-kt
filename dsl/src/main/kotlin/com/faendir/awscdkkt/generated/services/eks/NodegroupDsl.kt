...
@Generated
public fun Construct.nodegroup(id: String, props: NodegroupProps): Nodegroup = Nodegroup(this, id,
    props)
...
@Generated
public fun Construct.buildNodegroup(id: String, initializer: @AwsCdkDsl
    Nodegroup.Builder.() -> Unit): Nodegroup = Nodegroup.Builder.create(this,
