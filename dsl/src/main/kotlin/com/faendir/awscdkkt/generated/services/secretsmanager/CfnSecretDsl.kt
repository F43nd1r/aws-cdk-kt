...
@Generated
public fun Construct.cfnSecret(id: String, initializer: @AwsCdkDsl CfnSecret.() -> Unit = {}):
    CfnSecret = CfnSecret(this, id).apply(initializer)
...
@Generated
public fun Construct.buildCfnSecret(id: String, initializer: @AwsCdkDsl CfnSecret.Builder.() -> Unit
    = {}): CfnSecret = CfnSecret.Builder.create(this, id).apply(initializer).build()
