...
@Generated
public fun Construct.buildCfnFlowEntitlement(id: String, initializer: @AwsCdkDsl CfnFlowEntitlement.Builder.() -> Unit = {}): CfnFlowEntitlement = CfnFlowEntitlement.Builder.create(this, id).apply(initializer).build()
