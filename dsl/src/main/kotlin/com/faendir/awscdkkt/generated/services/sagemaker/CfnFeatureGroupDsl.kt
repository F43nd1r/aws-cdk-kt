...
@Generated
public fun Construct.buildCfnFeatureGroup(id: String, initializer: @AwsCdkDsl CfnFeatureGroup.Builder.() -> Unit = {}): CfnFeatureGroup = CfnFeatureGroup.Builder.create(this, id).apply(initializer).build()
