...
@Generated
public fun Construct.profilingGroup(id: String, initializer: @AwsCdkDsl ProfilingGroup.() -> Unit = {}): ProfilingGroup = ProfilingGroup(this, id).apply(initializer)
...
@Generated
public fun Construct.buildProfilingGroup(id: String, initializer: @AwsCdkDsl ProfilingGroup.Builder.() -> Unit = {}): ProfilingGroup = ProfilingGroup.Builder.create(this, id).apply(initializer).build()
