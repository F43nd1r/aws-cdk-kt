...
@Generated
public fun Construct.buildNsRecord(id: String, initializer: @AwsCdkDsl NsRecord.Builder.() -> Unit = {}): NsRecord = NsRecord.Builder.create(this, id).apply(initializer).build()
