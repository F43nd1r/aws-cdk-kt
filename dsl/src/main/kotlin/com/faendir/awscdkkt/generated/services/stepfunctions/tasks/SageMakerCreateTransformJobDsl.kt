...
@Generated
public fun Construct.sageMakerCreateTransformJob(id: String,
    props: SageMakerCreateTransformJobProps): SageMakerCreateTransformJob =
    SageMakerCreateTransformJob(this, id, props)
