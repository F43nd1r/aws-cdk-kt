...
@Generated
public fun Construct.buildCfnConnectionGroup(id: String, initializer: @AwsCdkDsl CfnConnectionGroup.Builder.() -> Unit = {}): CfnConnectionGroup = CfnConnectionGroup.Builder.create(this, id).apply(initializer).build()
