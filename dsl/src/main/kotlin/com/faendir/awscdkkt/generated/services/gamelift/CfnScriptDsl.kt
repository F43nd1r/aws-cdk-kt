...
@Generated
public fun Construct.cfnScript(id: String, props: CfnScriptProps): CfnScript = CfnScript(this, id,
    props)
...
@Generated
public fun Construct.buildCfnScript(id: String, initializer: @AwsCdkDsl
    CfnScript.Builder.() -> Unit): CfnScript = CfnScript.Builder.create(this,
