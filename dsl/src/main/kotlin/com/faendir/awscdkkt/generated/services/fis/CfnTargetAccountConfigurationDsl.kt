...
@Generated
public fun Construct.buildCfnTargetAccountConfiguration(id: String, initializer: @AwsCdkDsl CfnTargetAccountConfiguration.Builder.() -> Unit = {}): CfnTargetAccountConfiguration = CfnTargetAccountConfiguration.Builder.create(this, id).apply(initializer).build()
