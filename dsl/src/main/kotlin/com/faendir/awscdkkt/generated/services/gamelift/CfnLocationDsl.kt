...
@Generated
public fun Construct.buildCfnLocation(id: String, initializer: @AwsCdkDsl CfnLocation.Builder.() -> Unit = {}): CfnLocation = CfnLocation.Builder.create(this, id).apply(initializer).build()
