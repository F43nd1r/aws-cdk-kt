...
@Generated
public fun Construct.buildCfnDefaultViewAssociation(id: String, initializer: @AwsCdkDsl CfnDefaultViewAssociation.Builder.() -> Unit = {}): CfnDefaultViewAssociation = CfnDefaultViewAssociation.Builder.create(this, id).apply(initializer).build()
