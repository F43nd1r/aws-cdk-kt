...
@Generated
public fun buildAutomationRulesFindingFieldsUpdateProperty(initializer: @AwsCdkDsl CfnAutomationRule.AutomationRulesFindingFieldsUpdateProperty.Builder.() -> Unit = {}): CfnAutomationRule.AutomationRulesFindingFieldsUpdateProperty = CfnAutomationRule.AutomationRulesFindingFieldsUpdateProperty.Builder().apply(initializer).build()
