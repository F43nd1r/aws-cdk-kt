...
@Generated
public fun Construct.accessKey(id: String, props: AccessKeyProps): AccessKey = AccessKey(this, id,
    props)
...
@Generated
public fun Construct.buildAccessKey(id: String, initializer: @AwsCdkDsl
    AccessKey.Builder.() -> Unit): AccessKey = AccessKey.Builder.create(this,
