...
@Generated
public fun Construct.buildCfnFlowSource(id: String, initializer: @AwsCdkDsl CfnFlowSource.Builder.() -> Unit = {}): CfnFlowSource = CfnFlowSource.Builder.create(this, id).apply(initializer).build()
