...
@Generated
public fun Construct.buildCfnOriginEndpoint(id: String, initializer: @AwsCdkDsl CfnOriginEndpoint.Builder.() -> Unit = {}): CfnOriginEndpoint = CfnOriginEndpoint.Builder.create(this, id).apply(initializer).build()
