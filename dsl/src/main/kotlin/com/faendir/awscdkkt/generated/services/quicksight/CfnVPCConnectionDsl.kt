...
@Generated
public fun Construct.cfnVPCConnection(id: String, initializer: @AwsCdkDsl CfnVPCConnection.() -> Unit = {}): CfnVPCConnection = CfnVPCConnection(this, id).apply(initializer)
