...
@Generated
public fun Construct.buildCfnVirtualGateway(id: String, initializer: @AwsCdkDsl CfnVirtualGateway.Builder.() -> Unit = {}): CfnVirtualGateway = CfnVirtualGateway.Builder.create(this, id).apply(initializer).build()
