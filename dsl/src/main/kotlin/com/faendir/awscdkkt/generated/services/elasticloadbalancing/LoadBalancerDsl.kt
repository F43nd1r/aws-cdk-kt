...
@Generated
public fun Construct.buildLoadBalancer(id: String, initializer: @AwsCdkDsl LoadBalancer.Builder.() -> Unit = {}): LoadBalancer = LoadBalancer.Builder.create(this, id).apply(initializer).build()
