...
@Generated
public fun Construct.buildCfnVersion(id: String, initializer: @AwsCdkDsl CfnVersion.Builder.() -> Unit = {}): CfnVersion = CfnVersion.Builder.create(this, id).apply(initializer).build()
