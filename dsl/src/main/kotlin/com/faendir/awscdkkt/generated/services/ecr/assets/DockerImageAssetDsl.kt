...
@Generated
public fun Construct.buildDockerImageAsset(id: String, initializer: @AwsCdkDsl DockerImageAsset.Builder.() -> Unit = {}): DockerImageAsset = DockerImageAsset.Builder.create(this, id).apply(initializer).build()
