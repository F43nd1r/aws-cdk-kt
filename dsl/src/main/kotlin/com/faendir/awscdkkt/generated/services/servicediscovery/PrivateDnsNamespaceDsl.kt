...
@Generated
public fun Construct.buildPrivateDnsNamespace(id: String, initializer: @AwsCdkDsl PrivateDnsNamespace.Builder.() -> Unit = {}): PrivateDnsNamespace = PrivateDnsNamespace.Builder.create(this, id).apply(initializer).build()
