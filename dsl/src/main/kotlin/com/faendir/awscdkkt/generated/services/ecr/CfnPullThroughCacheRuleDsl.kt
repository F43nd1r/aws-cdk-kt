...
public fun Construct.cfnPullThroughCacheRule(id: String, initializer: @AwsCdkDsl
    CfnPullThroughCacheRule.() -> Unit = {}): CfnPullThroughCacheRule =
...
public fun Construct.buildCfnPullThroughCacheRule(id: String, initializer: @AwsCdkDsl
    CfnPullThroughCacheRule.Builder.() -> Unit = {}): CfnPullThroughCacheRule =
    CfnPullThroughCacheRule.Builder.create(this, id).apply(initializer).build()
