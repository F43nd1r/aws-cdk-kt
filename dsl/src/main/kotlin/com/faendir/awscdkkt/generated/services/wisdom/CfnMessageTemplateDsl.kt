...
@Generated
public fun Construct.buildCfnMessageTemplate(id: String, initializer: @AwsCdkDsl
    CfnMessageTemplate.Builder.() -> Unit = {}): CfnMessageTemplate =
    CfnMessageTemplate.Builder.create(this, id).apply(initializer).build()
