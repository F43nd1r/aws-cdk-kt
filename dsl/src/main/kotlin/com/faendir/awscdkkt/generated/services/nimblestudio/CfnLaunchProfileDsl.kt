...
@Generated
public fun Construct.buildCfnLaunchProfile(id: String, initializer: @AwsCdkDsl CfnLaunchProfile.Builder.() -> Unit = {}): CfnLaunchProfile = CfnLaunchProfile.Builder.create(this, id).apply(initializer).build()
