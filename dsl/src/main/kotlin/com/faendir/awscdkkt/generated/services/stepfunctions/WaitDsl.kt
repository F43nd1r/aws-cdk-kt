...
@Generated
public fun Construct.wait(id: String, props: WaitProps): Wait = Wait(this, id, props)
...
@Generated
public fun Construct.buildWait(id: String, initializer: @AwsCdkDsl Wait.Builder.() -> Unit): Wait =
    Wait.Builder.create(this, id).apply(initializer).build()
