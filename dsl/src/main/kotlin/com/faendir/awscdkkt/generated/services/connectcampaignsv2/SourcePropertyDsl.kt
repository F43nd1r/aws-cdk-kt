...
@Generated
public fun buildSourceProperty(initializer: @AwsCdkDsl CfnCampaign.SourceProperty.Builder.() -> Unit
    = {}): CfnCampaign.SourceProperty =
    CfnCampaign.SourceProperty.Builder().apply(initializer).build()
