...
@Generated
public fun Construct.cfnKnowledgeBase(id: String, props: CfnKnowledgeBaseProps): CfnKnowledgeBase =
    CfnKnowledgeBase(this, id, props)
...
public fun Construct.buildCfnKnowledgeBase(id: String, initializer: @AwsCdkDsl
    CfnKnowledgeBase.Builder.() -> Unit): CfnKnowledgeBase = CfnKnowledgeBase.Builder.create(this,
