...
@Generated
public fun Construct.cfnEnvironmentTemplate(id: String, initializer: @AwsCdkDsl CfnEnvironmentTemplate.() -> Unit = {}): CfnEnvironmentTemplate = CfnEnvironmentTemplate(this, id).apply(initializer)
...
@Generated
public fun Construct.buildCfnEnvironmentTemplate(id: String, initializer: @AwsCdkDsl CfnEnvironmentTemplate.Builder.() -> Unit = {}): CfnEnvironmentTemplate = CfnEnvironmentTemplate.Builder.create(this, id).apply(initializer).build()
