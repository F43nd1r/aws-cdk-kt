...
@Generated
public fun Construct.helmChart(id: String, props: HelmChartProps): HelmChart = HelmChart(this, id,
    props)
...
@Generated
public fun Construct.buildHelmChart(id: String, initializer: @AwsCdkDsl
    HelmChart.Builder.() -> Unit): HelmChart = HelmChart.Builder.create(this,
