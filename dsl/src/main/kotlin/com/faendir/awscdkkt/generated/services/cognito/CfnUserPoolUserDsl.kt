...
@Generated
public fun Construct.buildCfnUserPoolUser(id: String, initializer: @AwsCdkDsl CfnUserPoolUser.Builder.() -> Unit = {}): CfnUserPoolUser = CfnUserPoolUser.Builder.create(this, id).apply(initializer).build()
