...
@Generated
public fun Construct.cfnReceiptRuleSet(id: String, initializer: @AwsCdkDsl CfnReceiptRuleSet.() -> Unit = {}): CfnReceiptRuleSet = CfnReceiptRuleSet(this, id).apply(initializer)
...
@Generated
public fun Construct.buildCfnReceiptRuleSet(id: String, initializer: @AwsCdkDsl CfnReceiptRuleSet.Builder.() -> Unit = {}): CfnReceiptRuleSet = CfnReceiptRuleSet.Builder.create(this, id).apply(initializer).build()
