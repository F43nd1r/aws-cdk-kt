...
@Generated
public fun Construct.buildCfnLoggerDefinition(id: String, initializer: @AwsCdkDsl CfnLoggerDefinition.Builder.() -> Unit = {}): CfnLoggerDefinition = CfnLoggerDefinition.Builder.create(this, id).apply(initializer).build()
