...
@Generated
public fun Construct.cfnPartnerAccount(id: String, initializer: @AwsCdkDsl CfnPartnerAccount.() -> Unit = {}): CfnPartnerAccount = CfnPartnerAccount(this, id).apply(initializer)
...
@Generated
public fun Construct.buildCfnPartnerAccount(id: String, initializer: @AwsCdkDsl CfnPartnerAccount.Builder.() -> Unit = {}): CfnPartnerAccount = CfnPartnerAccount.Builder.create(this, id).apply(initializer).build()
