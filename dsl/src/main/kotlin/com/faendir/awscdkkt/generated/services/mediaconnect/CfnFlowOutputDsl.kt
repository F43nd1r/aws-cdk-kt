...
@Generated
public fun Construct.buildCfnFlowOutput(id: String, initializer: @AwsCdkDsl CfnFlowOutput.Builder.() -> Unit = {}): CfnFlowOutput = CfnFlowOutput.Builder.create(this, id).apply(initializer).build()
