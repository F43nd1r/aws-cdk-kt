...
@Generated
public fun Construct.buildCfnRobot(id: String, initializer: @AwsCdkDsl CfnRobot.Builder.() -> Unit = {}): CfnRobot = CfnRobot.Builder.create(this, id).apply(initializer).build()
