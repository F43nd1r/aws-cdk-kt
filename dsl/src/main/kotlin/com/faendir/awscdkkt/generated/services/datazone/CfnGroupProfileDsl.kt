...
@Generated
public fun Construct.buildCfnGroupProfile(id: String, initializer: @AwsCdkDsl CfnGroupProfile.Builder.() -> Unit = {}): CfnGroupProfile = CfnGroupProfile.Builder.create(this, id).apply(initializer).build()
