...
@Generated
public fun Construct.dynamoDeleteItem(id: String, props: DynamoDeleteItemProps): DynamoDeleteItem =
    DynamoDeleteItem(this, id, props)
...
public fun Construct.buildDynamoDeleteItem(id: String, initializer: @AwsCdkDsl
    DynamoDeleteItem.Builder.() -> Unit): DynamoDeleteItem = DynamoDeleteItem.Builder.create(this,
