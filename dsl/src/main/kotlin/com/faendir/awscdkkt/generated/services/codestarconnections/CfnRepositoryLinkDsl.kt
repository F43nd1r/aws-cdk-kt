...
@Generated
public fun Construct.buildCfnRepositoryLink(id: String, initializer: @AwsCdkDsl CfnRepositoryLink.Builder.() -> Unit = {}): CfnRepositoryLink = CfnRepositoryLink.Builder.create(this, id).apply(initializer).build()
