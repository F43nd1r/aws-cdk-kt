...
@Generated
public fun Construct.buildCfnPromptVersion(id: String, initializer: @AwsCdkDsl
    CfnPromptVersion.Builder.() -> Unit = {}): CfnPromptVersion =
    CfnPromptVersion.Builder.create(this, id).apply(initializer).build()
