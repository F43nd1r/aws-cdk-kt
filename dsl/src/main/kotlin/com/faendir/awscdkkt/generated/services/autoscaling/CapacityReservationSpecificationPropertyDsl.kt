...
public fun buildCapacityReservationSpecificationProperty(initializer: @AwsCdkDsl
    CfnAutoScalingGroup.CapacityReservationSpecificationProperty.Builder.() -> Unit = {}):
    CfnAutoScalingGroup.CapacityReservationSpecificationProperty =
    CfnAutoScalingGroup.CapacityReservationSpecificationProperty.Builder().apply(initializer).build()
