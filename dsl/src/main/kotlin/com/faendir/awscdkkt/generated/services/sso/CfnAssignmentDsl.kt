...
@Generated
public fun Construct.buildCfnAssignment(id: String, initializer: @AwsCdkDsl CfnAssignment.Builder.() -> Unit = {}): CfnAssignment = CfnAssignment.Builder.create(this, id).apply(initializer).build()
