...
@Generated
public fun Construct.buildCfnMatchingWorkflow(id: String, initializer: @AwsCdkDsl CfnMatchingWorkflow.Builder.() -> Unit = {}): CfnMatchingWorkflow = CfnMatchingWorkflow.Builder.create(this, id).apply(initializer).build()
