...
@Generated
public fun Construct.buildCfnCustomerGateway(id: String, initializer: @AwsCdkDsl CfnCustomerGateway.Builder.() -> Unit = {}): CfnCustomerGateway = CfnCustomerGateway.Builder.create(this, id).apply(initializer).build()
