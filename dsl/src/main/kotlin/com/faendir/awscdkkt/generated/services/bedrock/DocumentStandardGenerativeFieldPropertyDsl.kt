...
@Generated
public fun buildDocumentStandardGenerativeFieldProperty(initializer: @AwsCdkDsl CfnDataAutomationProject.DocumentStandardGenerativeFieldProperty.Builder.() -> Unit = {}): CfnDataAutomationProject.DocumentStandardGenerativeFieldProperty = CfnDataAutomationProject.DocumentStandardGenerativeFieldProperty.Builder().apply(initializer).build()
