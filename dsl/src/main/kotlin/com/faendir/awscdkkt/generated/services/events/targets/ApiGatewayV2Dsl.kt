...
@Generated
public fun buildApiGatewayV2(httpApi: IHttpApi, initializer: @AwsCdkDsl
    ApiGatewayV2.Builder.() -> Unit = {}): ApiGatewayV2 =
    ApiGatewayV2.Builder.create(httpApi).apply(initializer).build()
