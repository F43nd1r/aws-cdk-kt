...
@Generated
public fun buildImageStandardOutputConfigurationProperty(initializer: @AwsCdkDsl CfnDataAutomationProject.ImageStandardOutputConfigurationProperty.Builder.() -> Unit = {}): CfnDataAutomationProject.ImageStandardOutputConfigurationProperty = CfnDataAutomationProject.ImageStandardOutputConfigurationProperty.Builder().apply(initializer).build()
