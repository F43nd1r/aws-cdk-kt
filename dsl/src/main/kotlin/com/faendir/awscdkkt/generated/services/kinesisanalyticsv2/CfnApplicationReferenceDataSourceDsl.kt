...
): CfnApplicationReferenceDataSource = CfnApplicationReferenceDataSource(this, id, props).apply(initializer)

@Generated
public fun Construct.buildCfnApplicationReferenceDataSource(id: String, initializer: @AwsCdkDsl CfnApplicationReferenceDataSource.Builder.() -> Unit = {}): CfnApplicationReferenceDataSource = CfnApplicationReferenceDataSource.Builder.create(this, id).apply(initializer).build()
