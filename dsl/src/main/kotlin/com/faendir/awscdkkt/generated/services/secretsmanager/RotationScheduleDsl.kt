...
@Generated
public fun Construct.rotationSchedule(id: String, props: RotationScheduleProps): RotationSchedule =
    RotationSchedule(this, id, props)
...
public fun Construct.buildRotationSchedule(id: String, initializer: @AwsCdkDsl
    RotationSchedule.Builder.() -> Unit): RotationSchedule = RotationSchedule.Builder.create(this,
