...
@Generated
public fun Construct.buildPublicHostedZone(id: String, initializer: @AwsCdkDsl PublicHostedZone.Builder.() -> Unit = {}): PublicHostedZone = PublicHostedZone.Builder.create(this, id).apply(initializer).build()
