...
@Generated
public fun Construct.publicHostedZone(id: String, props: PublicHostedZoneProps): PublicHostedZone =
    PublicHostedZone(this, id, props)
...
public fun Construct.buildPublicHostedZone(id: String, initializer: @AwsCdkDsl
    PublicHostedZone.Builder.() -> Unit): PublicHostedZone = PublicHostedZone.Builder.create(this,
