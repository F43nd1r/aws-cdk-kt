...
@Generated
public fun Construct.txtRecord(id: String, props: TxtRecordProps): TxtRecord = TxtRecord(this, id,
    props)
...
@Generated
public fun Construct.buildTxtRecord(id: String, initializer: @AwsCdkDsl
    TxtRecord.Builder.() -> Unit): TxtRecord = TxtRecord.Builder.create(this,
