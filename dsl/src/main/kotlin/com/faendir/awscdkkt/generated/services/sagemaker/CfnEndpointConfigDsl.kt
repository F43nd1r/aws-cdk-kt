...
@Generated
public fun Construct.buildCfnEndpointConfig(id: String, initializer: @AwsCdkDsl CfnEndpointConfig.Builder.() -> Unit = {}): CfnEndpointConfig = CfnEndpointConfig.Builder.create(this, id).apply(initializer).build()
