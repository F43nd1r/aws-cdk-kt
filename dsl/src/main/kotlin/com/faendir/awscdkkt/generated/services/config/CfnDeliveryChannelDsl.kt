...
@Generated
public fun Construct.buildCfnDeliveryChannel(id: String, initializer: @AwsCdkDsl CfnDeliveryChannel.Builder.() -> Unit = {}): CfnDeliveryChannel = CfnDeliveryChannel.Builder.create(this, id).apply(initializer).build()
