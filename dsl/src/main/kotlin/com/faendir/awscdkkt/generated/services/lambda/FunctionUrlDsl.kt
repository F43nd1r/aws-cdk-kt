...
@Generated
public fun Construct.buildFunctionUrl(id: String, initializer: @AwsCdkDsl FunctionUrl.Builder.() -> Unit = {}): FunctionUrl = FunctionUrl.Builder.create(this, id).apply(initializer).build()
