...
@Generated
public fun Construct.buildCfnReceiptFilter(id: String, initializer: @AwsCdkDsl CfnReceiptFilter.Builder.() -> Unit = {}): CfnReceiptFilter = CfnReceiptFilter.Builder.create(this, id).apply(initializer).build()
