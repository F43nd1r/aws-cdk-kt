...
@Generated
public fun Construct.buildCfnAlarm(id: String, initializer: @AwsCdkDsl CfnAlarm.Builder.() -> Unit = {}): CfnAlarm = CfnAlarm.Builder.create(this, id).apply(initializer).build()
