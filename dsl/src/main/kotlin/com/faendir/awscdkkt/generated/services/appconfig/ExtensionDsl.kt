...
@Generated
public fun Construct.buildExtension(id: String, initializer: @AwsCdkDsl Extension.Builder.() -> Unit = {}): Extension = Extension.Builder.create(this, id).apply(initializer).build()
