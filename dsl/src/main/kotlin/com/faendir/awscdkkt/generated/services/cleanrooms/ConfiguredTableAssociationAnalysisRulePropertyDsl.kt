...
@Generated
public fun buildConfiguredTableAssociationAnalysisRuleProperty(initializer: @AwsCdkDsl CfnConfiguredTableAssociation.ConfiguredTableAssociationAnalysisRuleProperty.Builder.() -> Unit = {}): CfnConfiguredTableAssociation.ConfiguredTableAssociationAnalysisRuleProperty = CfnConfiguredTableAssociation.ConfiguredTableAssociationAnalysisRuleProperty.Builder().apply(initializer).build()
