...
@Generated
public fun Construct.buildCfnImageRecipe(id: String, initializer: @AwsCdkDsl CfnImageRecipe.Builder.() -> Unit = {}): CfnImageRecipe = CfnImageRecipe.Builder.create(this, id).apply(initializer).build()
