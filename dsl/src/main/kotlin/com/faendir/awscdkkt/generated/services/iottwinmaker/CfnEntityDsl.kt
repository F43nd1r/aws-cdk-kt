...
@Generated
public fun Construct.buildCfnEntity(id: String, initializer: @AwsCdkDsl CfnEntity.Builder.() -> Unit = {}): CfnEntity = CfnEntity.Builder.create(this, id).apply(initializer).build()
