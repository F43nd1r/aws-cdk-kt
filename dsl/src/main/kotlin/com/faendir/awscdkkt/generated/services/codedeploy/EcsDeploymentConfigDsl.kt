...
@Generated
public fun Construct.ecsDeploymentConfig(id: String, initializer: @AwsCdkDsl EcsDeploymentConfig.() -> Unit = {}): EcsDeploymentConfig = EcsDeploymentConfig(this, id).apply(initializer)
...
@Generated
public fun Construct.buildEcsDeploymentConfig(id: String, initializer: @AwsCdkDsl EcsDeploymentConfig.Builder.() -> Unit = {}): EcsDeploymentConfig = EcsDeploymentConfig.Builder.create(this, id).apply(initializer).build()
