...
@Generated
public fun Construct.buildCfnManagedPolicy(id: String, initializer: @AwsCdkDsl CfnManagedPolicy.Builder.() -> Unit = {}): CfnManagedPolicy = CfnManagedPolicy.Builder.create(this, id).apply(initializer).build()
