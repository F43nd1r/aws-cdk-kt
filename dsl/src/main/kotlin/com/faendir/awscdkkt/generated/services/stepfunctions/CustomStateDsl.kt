...
@Generated
public fun Construct.buildCustomState(id: String, initializer: @AwsCdkDsl CustomState.Builder.() -> Unit = {}): CustomState = CustomState.Builder.create(this, id).apply(initializer).build()
