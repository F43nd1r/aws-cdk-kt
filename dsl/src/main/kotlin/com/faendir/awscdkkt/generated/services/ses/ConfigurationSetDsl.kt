...
@Generated
public fun Construct.configurationSet(id: String): ConfigurationSet = ConfigurationSet(this, id)

@Generated
public fun Construct.configurationSet(id: String, initializer: @AwsCdkDsl
    ConfigurationSet.() -> Unit): ConfigurationSet = ConfigurationSet(this, id).apply(initializer)

@Generated
public fun Construct.configurationSet(id: String, props: ConfigurationSetProps): ConfigurationSet =
    ConfigurationSet(this, id, props)
...
public fun Construct.buildConfigurationSet(id: String, initializer: @AwsCdkDsl
    ConfigurationSet.Builder.() -> Unit): ConfigurationSet = ConfigurationSet.Builder.create(this,
