...
@Generated
public fun Construct.configurationSet(id: String, initializer: @AwsCdkDsl ConfigurationSet.() -> Unit = {}): ConfigurationSet = ConfigurationSet(this, id).apply(initializer)
...
@Generated
public fun Construct.buildConfigurationSet(id: String, initializer: @AwsCdkDsl ConfigurationSet.Builder.() -> Unit = {}): ConfigurationSet = ConfigurationSet.Builder.create(this, id).apply(initializer).build()
