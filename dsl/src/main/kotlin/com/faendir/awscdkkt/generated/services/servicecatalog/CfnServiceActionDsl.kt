...
@Generated
public fun Construct.buildCfnServiceAction(id: String, initializer: @AwsCdkDsl CfnServiceAction.Builder.() -> Unit = {}): CfnServiceAction = CfnServiceAction.Builder.create(this, id).apply(initializer).build()
