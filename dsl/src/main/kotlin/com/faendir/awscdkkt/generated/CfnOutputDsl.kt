...
@Generated
public fun Construct.buildCfnOutput(id: String, initializer: @AwsCdkDsl CfnOutput.Builder.() -> Unit = {}): CfnOutput = CfnOutput.Builder.create(this, id).apply(initializer).build()
