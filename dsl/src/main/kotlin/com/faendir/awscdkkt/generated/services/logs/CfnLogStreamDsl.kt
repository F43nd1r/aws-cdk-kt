...
@Generated
public fun Construct.buildCfnLogStream(id: String, initializer: @AwsCdkDsl CfnLogStream.Builder.() -> Unit = {}): CfnLogStream = CfnLogStream.Builder.create(this, id).apply(initializer).build()
