...
@Generated
public fun Construct.buildCfnRoutingControl(id: String, initializer: @AwsCdkDsl CfnRoutingControl.Builder.() -> Unit = {}): CfnRoutingControl = CfnRoutingControl.Builder.create(this, id).apply(initializer).build()
