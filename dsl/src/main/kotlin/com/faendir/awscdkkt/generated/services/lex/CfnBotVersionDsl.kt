...
@Generated
public fun Construct.buildCfnBotVersion(id: String, initializer: @AwsCdkDsl CfnBotVersion.Builder.() -> Unit = {}): CfnBotVersion = CfnBotVersion.Builder.create(this, id).apply(initializer).build()
