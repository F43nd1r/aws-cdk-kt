...
@Generated
public fun Construct.buildCfnPackagingGroup(id: String, initializer: @AwsCdkDsl CfnPackagingGroup.Builder.() -> Unit = {}): CfnPackagingGroup = CfnPackagingGroup.Builder.create(this, id).apply(initializer).build()
