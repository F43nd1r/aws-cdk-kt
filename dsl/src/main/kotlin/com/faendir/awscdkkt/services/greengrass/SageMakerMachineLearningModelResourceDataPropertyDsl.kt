...
public
    fun sageMakerMachineLearningModelResourceDataProperty(initializer: CfnResourceDefinitionVersion.SageMakerMachineLearningModelResourceDataProperty.Builder.() -> Unit):
